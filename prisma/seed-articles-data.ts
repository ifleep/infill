// Demo INFiLL Lab articles — the same 6 articles that used to live as a
// static array in src/lib/data/articles.ts before that module became
// DB-backed (see prisma/seed.ts). `paragraphs` becomes one richText content
// block per paragraph on seed.
