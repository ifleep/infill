...
const technologies = [
  { label: "FDM / FFF", href: "/category/3d-printers?tech=FDM", copy: "The everyday workhorse — accessible, versatile, and material-rich." },
  { label: "Resin", href: "/category/3d-printers?tech=Resin", copy: "Fine detail and smooth surface finish for miniatures and masters." },
  { label: "CoreXY", href: "/category/3d-printers?tech=CoreXY", copy: "Enclosed, high-speed motion systems built for volume." },
  { label: "Large Format", href: "/category/3d-printers?tech=Large+Format", copy: "For parts — and ambitions — that outgrow a standard bed." },
  { label: "Industrial", href: "/category/3d-printers?tech=Industrial", copy: "Production-grade reliability for continuous duty." },
  { label: "Educational", href: "/category/3d-printers?tech=Educational", copy: "Built for classrooms, labs, and first-time makers." },
];
