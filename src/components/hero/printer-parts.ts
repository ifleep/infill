...
export const printerParts: PrinterPart[] = [
  ...
  // ---- Rails ----
  { id: "rail-x1", label: "X rail", geometry: { kind: "cylinder", args: [0.03, 0.03, 2.2, 12] }, color: gray, metalness: 0.8, roughness: 0.25, restPosition: [0, 2.2, 0.18], restRotation: [0, 0, Math.PI / 2], explodeOffset: [0, 1.4, 1.8], explodeRotation: [0, 0.6, Math.PI / 2], settleOrder: 0.2 },
  { id: "rail-x2", label: "X rail", geometry: { kind: "cylinder", args: [0.03, 0.03, 2.2, 12] }, color: gray, metalness: 0.8, roughness: 0.25, restPosition: [0, 2.2, -0.18], restRotation: [0, 0, Math.PI / 2], explodeOffset: [0, 1.4, -1.8], explodeRotation: [0, -0.6, Math.PI / 2], settleOrder: 0.2 },
  { id: "rail-z1", label: "Z rail", geometry: { kind: "cylinder", args: [0.035, 0.035, 2.4, 12] }, color: gray, metalness: 0.8, roughness: 0.25, restPosition: [0.95, 1.3, -0.9], explodeOffset: [1.9, -0.4, -1.2], explodeRotation: [0.3, 0, 0], settleOrder: 0.18 },
  { id: "rail-z2", label: "Z rail", geometry: { kind: "cylinder", args: [0.035, 0.035, 2.4, 12] }, color: gray, metalness: 0.8, roughness: 0.25, restPosition: [-0.95, 1.3, -0.9], explodeOffset: [-1.9, -0.4, -1.2], explodeRotation: [-0.3, 0, 0], settleOrder: 0.18 },
  ...
  { id: "motor-z", label: "Z motor", geometry: { kind: "cylinder", args: [0.14, 0.14, 0.24, 16] }, color: black, metalness: 0.5, roughness: 0.5, restPosition: [0.95, 0.2, -0.95], explodeOffset: [1.6, -1.0, -1.6], explodeRotation: [0, 0.5, 0.3], settleOrder: 0.28 },
  { id: "motor-e", label: "Extruder motor", geometry: { kind: "cylinder", args: [0.11, 0.11, 0.18, 16] }, color: black, metalness: 0.5, roughness: 0.5, restPosition: [0.2, 2.05, 0.32], explodeOffset: [1.3, 0.9, 1.5], explodeRotation: [0.5, 0, 0.2], ridesGantry: true, settleOrder: 0.42 },
  ...
  { id: "heatsink", label: "Heat sink", geometry: { kind: "cylinder", args: [0.06, 0.06, 0.22, 12] }, color: gray, metalness: 0.7, roughness: 0.3, restPosition: [0, 1.82, 0], explodeOffset: [-0.3, 1.3, 2.4], explodeRotation: [0.3, 0.2, 0], ridesGantry: true, settleOrder: 0.5 },
  { id: "nozzle", label: "Hotend nozzle", geometry: { kind: "cone", args: [0.045, 0.12, 16] }, color: brass, metalness: 0.8, roughness: 0.25, restPosition: [0, 1.66, 0], restRotation: [Math.PI, 0, 0], explodeOffset: [0.2, 0.9, 2.6], explodeRotation: [0.8, 0.4, 0], ridesGantry: true, settleOrder: 0.55 },
  { id: "fan-1", label: "Part-cooling fan", geometry: { kind: "cylinder", args: [0.09, 0.09, 0.04, 16] }, color: gray, roughness: 0.5, restPosition: [0.16, 1.95, 0.14], restRotation: [Math.PI / 2, 0, 0], explodeOffset: [1.1, 1.5, 1.9], explodeRotation: [0, 0.9, 0], ridesGantry: true, settleOrder: 0.48 },
  { id: "fan-2", label: "Hotend fan", geometry: { kind: "cylinder", args: [0.07, 0.07, 0.04, 16] }, color: gray, roughness: 0.5, restPosition: [-0.16, 2.05, 0.05], restRotation: [Math.PI / 2, 0.3, 0], explodeOffset: [-1.0, 1.7, 1.7], explodeRotation: [0, -0.9, 0], ridesGantry: true, settleOrder: 0.48 },
  ...
  // ---- Filament path ----
  { id: "spool", label: "Filament spool", geometry: { kind: "cylinder", args: [0.28, 0.28, 0.12, 24] }, color: blueAccent, metalness: 0.2, roughness: 0.6, restPosition: [0, 2.75, -1.0], restRotation: [Math.PI / 2, 0, 0], explodeOffset: [0, 2.2, -2.4], explodeRotation: [0.3, 0.2, 0], settleOrder: 0.6 },
  { id: "ptfe-tube", label: "Filament guide tube", geometry: { kind: "cylinder", args: [0.02, 0.02, 0.9, 8] }, color: "#2a2f38", restPosition: [0, 2.35, -0.5], restRotation: [1.1, 0, 0], explodeOffset: [0.6, 1.9, -2.0], explodeRotation: [0.5, 0.5, 0], settleOrder: 0.62 },
